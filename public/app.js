...
/***/ function(module, exports, __webpack_require__) {
		...
		render: function() {
			...
			return (
					React.createElement("div", null, 
						React.createElement(ReactNotify, {ref: "notificator"}), 
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("c:\\Users\\No\\WebstormProjects\\React Notify\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "show.js" + ": " + err.message); } }); } } })(); }
	...
	var Notify = React.createClass({displayName: "Notify",
		...
		render: function() {
			...
			var el = keys.map(function(key) {
				return React.createElement(Item, {id: key, 
											 key: key, 
